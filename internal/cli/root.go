...
func NewRootCmd(info BuildInfo) *cobra.Command {
	...
	cmd.AddCommand(
		...
		commands.NewPetsCmd(),
		commands.NewContactsCmd(),
		commands.NewMembershipsCmd(),
		commands.NewInvitationsCmd(),
		commands.NewAccountSharesCmd(),
		commands.NewVehiclesCmd(),
		commands.NewRealEstatesCmd(),
		commands.NewOnlineAccountsCmd(),
		commands.NewInsurancesCmd(),
		commands.NewWillsCmd(),
		commands.NewShareLinksCmd(),
		commands.NewUserSettingsCmd(),
